(() => {
  ...
  const businessExamples = ["독립서점", "반려식물 공방", "도자기 작업실", "비건 디저트숍", "향수 공방", "사진 스튜디오", "어린이 미술교실", "빈티지 소품점", "재즈 바", "로컬 여행사"];
  const companyExamples = ["달빛책방", "모모식물상점", "윤슬도자기", "초록한입", "오후의향기", "프레임온", "작은화가들", "시간상점", "블루노트룸", "골목여행소"];
